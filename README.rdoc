...
TRIO_APP_USERNAME     # used for staging environment to password protect
TRIO_APP_PASSWORD
TRIO_EMAIL_USERNAME   # Google Apps username - used for sending out emails
TRIO_EMAIL_PASSWORD   # Google Apps password - used for sending out emails
...
heroku config:set --app trio-staging TRIO_EMAIL_USERNAME=username
heroku config:set --app trio-staging TRIO_EMAIL_PASSWORD=my_secret_password
heroku config:set --app trio-staging TRIO_EMAIL_DOMAIN=my_secret_password

To set development environment variables, edit the .bash_profile file.  An example could be following:
export TRIO_APP_USERNAME='my_secret_password'
