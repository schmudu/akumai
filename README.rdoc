...
== TESTING
To run karma/jasmine run the following command in the project home directory after installing Jasmine/Karma (see Angular Google Docs(https://docs.angularjs.org/tutorial/step_02)):
